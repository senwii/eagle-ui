 ...
 * @show true
 * */
var ImgSlider = (0, _ClassNameMixin2.default)(_class = (_temp = _class2 = function (_Component) {
    _inherits(ImgSlider, _Component);

    function ImgSlider(props, context) {
        _classCallCheck(this, ImgSlider);

        var _this2 = _possibleConstructorReturn(this, (ImgSlider.__proto__ || Object.getPrototypeOf(ImgSlider)).call(this, props, context));
    ...
    _createClass(ImgSlider, [{
        ...
        key: 'renderDisplay',
        value: function renderDisplay(e) {
            //点击下方缩略图的情况
        ...
        value: function render() {
            ...
            var _state = this.state,
                ...
                thumbnailKey = _state.thumbnailKey,
                targetIndex = _state.targetIndex,
                thumbNailIndex = _state.thumbNailIndex,
                show = _state.show,
                showThumbnail = _state.showThumbnail;
            var _props = this.props,
                profileKey = _props.profileKey,
                urlKey = _props.urlKey,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { ref: 'slider-container', className: (0, _classnames2.default)('eg-slider-container', 'fadein', this.props.className), style: _extends({}, customizeStyle, containerStyle) },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'eg-slider-field-common eg-slider-field-left', onClick: function onClick() {
                                    return _this3.lowerIndex.call(_this3);
                                } },
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'eg-slider-field-common eg-slider-field-right', onClick: function onClick() {
                                    return _this3.addIndex.call(_this3);
                                } },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'eg-slider-field-common eg-slider-field-left', onClick: function onClick() {
                                    _this3.lowerIndex.call(_this3, pageNum);
                                } },
                            _react2.default.createElement('b', { className: 'eg-slider-arrow-left' })
                        ),
                        _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'eg-slider-field-common eg-slider-field-right', onClick: function onClick() {
                                    _this3.addIndex.call(_this3, pageNum);
                                } },
                            _react2.default.createElement('b', { className: 'eg-slider-arrow-right' })
                        )
                    )
...
var _temp2 = function () {
    ...
    __REACT_HOT_LOADER__.register(ImgSlider, 'ImgSlider', '/Users/panqianjin/work/eagle-ui/src/ImgSlider.js');
}();
