...
var PanelHeader = (function (_Component) {
    ...
    PanelHeader.prototype.render = function render() {
        ...
        return _react2['default'].createElement(
            'div',
            { className: this.props.leftFlag ? _classnames2['default'](this.getClassName('header'), this.getClassName('header-flag'), this.props.className) : _classnames2['default'](this.getClassName('header'), this.props.className), style: renderStyle },
            this.props.children
        );
    };
