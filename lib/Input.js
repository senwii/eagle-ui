...
var _utilsIcons = require('./utils/Icons');
...
var Input = (function (_Component) {
    ...
    Input.prototype.getIcon = function getIcon(type, checked, icon) {
        ...
        if (name) {
            return _react2['default'].createElement(Icon, { onClick: this.props.iconClickCallback, className: _classnames3['default']("input-icon"), name: name, style: iconStyle });
        }
