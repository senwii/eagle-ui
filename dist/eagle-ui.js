...
/***/ function(module, exports, __webpack_require__) {
	...
	['Grid', 'Col', 'Row', 'Button', 'ButtonGroup', 'Input', 'RadioGroup', 'Label', 'Crumb', 'Search', 'Select', 'LabelGroup', 'Toast', 'Paging', 'Calendar', 'Tab', 'Dialog', 'Tooltip', 'Panel', 'PanelContent', 'PanelFooter', 'PanelHeader', 'List', 'Item'].forEach(function (clazzName) {
