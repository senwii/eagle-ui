...
/***/ function(module, exports, __webpack_require__) {
	...
	['Grid', 'Col', 'Row', 'Button', 'ButtonGroup', 'Input', 'RadioGroup', 'Label', 'Crumb', 'Search', 'Select', 'LabelGroup', 'Toast', 'Paging', 'Calendar', 'Tab', 'Tabset', 'Dialog', 'Tooltip', 'Panel', 'PanelContent', 'PanelFooter', 'PanelHeader', 'List', 'Item', 'Table', 'Tr', 'Td', 'Th'].forEach(function (clazzName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Panel = (function (_Component) {
	    ...
	    Panel.prototype.render = function render() {
	        return _react2['default'].createElement(
	            'div',
	            { className: _classnames2['default'](this.getClassName('panel'), this.props.className) },
	            this.props.children
	        );
	    };
